class UsersRegisteredRestaurants {
  final int id;
  final String name;
  ...
  factory UsersRegisteredRestaurants.fromJson(Map<String, dynamic> json) {
    return UsersRegisteredRestaurants(
      id: json['id'],
      name: json['name'],
      address:
