...
// class RestaurantRegistatrationPage extends StatefulWidget {
//   String? latitude = '8.33333', longitude = '38.33333';
//   RestaurantRegistatrationPage(
//       {Key? key, required this.latitude, required this.longitude})
//       : super(key: key);

//   @override
//   State<RestaurantRegistatrationPage> createState() =>
//       _RestaurantRegistatrationPageState();
// }

// class _RestaurantRegistatrationPageState
//     extends State<RestaurantRegistatrationPage> {
...
//   Map<String, dynamic> urlData = {'restaurantImageEntities': []},
...
//   Future registerRestaurant() async {
...
//       print('this is  print $convertedTag');
//       try {
...
//           //           restaurantRegistered: true,
//           //         )));
//           Navigator.of(context).pop();
//           Provider.of<Fetch>(context, listen: false)
//               .showSuccessDialog(context, nameController.text);
//           // Flushbar(
//           //   maxWidth: MediaQuery.of(context).size.width * 0.90,
//           //   backgroundColor: Colors.green,
//           //   flushbarPosition: FlushbarPosition.TOP,
//           //   title: 'Registration Successful!',
//           //   message: 'You registered ${nameController.text} successfully!',
...
//             appBar: AppBar(
//               title: const TitleFont(text: 'Register New Restaurant'),
//               backgroundColor: AppColors.transparent,
//               elevation: 0,
...
//                                                       // '${_businessHourss[index].openDays1.single} from ${_businessHourss[index].startTime1.single} to ${_businessHourss[index].endTime1.single}',
...
//                                                   ));
//                                             },
//                                             itemCount: _businessHourss.length),
//                                       ],
//                                     ),
//                             ],
//                           ),
